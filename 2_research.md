...
<blockquote><p align = "justify" style="font-size:88%; margin-top: 0.5em"> <b>Callable debt</b>, a type of bond that allows the issuer to redeem the bond before its maturity date, has reached a high proportion of corporate finance structures in the U.S. debt market. This paper examines the dynamic interplay between corporate bond callability and firm decisions. Using a comprehensive dataset spanning firm- and bond-level data, this study reveals that firms with higher credit risk tend to issue a greater share of callable bonds. To analyze these dynamics, I develop a heterogeneous firm model with investment decisions, non-callable and callable debt, call options, and default risk. The model demonstrates that high-risk firms are more inclined to issue callable bonds, particularly when they face constrained liquidity. While firms with a larger proportion of callable debt are generally less likely to call these bonds, they tend to invest relatively more when they do call, driven by favorable investment opportunities. This behavior highlights the dual and asymmetric role of callable debt in risk management and investment decision.
</p></blockquote>
...
<div style="width: 575px; font-size:85%; margin-top: 1em; margin-bottom: 1em; margin-left: auto; margin-right: auto; text-align: justify;">
